...
v_lvllayout:	rs.b layout_size*$10	; level layout buffer ($400 bytes)
...
v_scrposy_vdp:	rs.w 1
v_bgscrposy_vdp:	rs.w 1		; background screen position y (duplicate) (2 bytes)
v_scrposx_vdp:	rs.w 1
v_bgscrposx_vdp:	rs.w 1		; background screen position x (duplicate) (2 bytes)
...
v_spritetablebuffer_end:	rs.b 0
			rs.b $80	; unused
v_palette:		rs.b palette_size
v_palette_end:	rs.b 0
v_palette_fading:	rs.b palette_size
