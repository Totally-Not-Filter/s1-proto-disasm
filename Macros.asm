...
; input: source, source_end, destination
; ---------------------------------------------------------------------------

writeVRAM:	macro source,source_end,destination
...
writeCRAM:	macro source,source_end,destination
		lea	(vdp_control_port).l,a5
		move.l	#$94000000+((((source_end-source)>>1)&$FF00)<<8)+$9300+(((source_end-source)>>1)&$FF),(a5)
		move.l	#$96000000+(((source>>1)&$FF00)<<8)+$9500+((source>>1)&$FF),(a5)
		move.w	#$9700+((((source>>1)&$FF0000)>>16)&$7F),(a5)
...
clearRAM:	macro startAddress,endAddress
		...
		moveq	#0,d0
		move.w	#(endAddress-startAddress)/4-1,d1
