...
Newt_Main:	; Routine 0
		...
		move.w	#ArtTile_Newtron|Tile_Pal2,obGfx(a0)	; set art tile and palette line
...
; ===========================================================================
Newt_ActIndex:
		dc.w	Newt_Action_ChkDistance-Newt_ActIndex	; 0
...
Newt_Action_ChkDistance:
	...
	.chkDistance:
		...
		move.w	#ArtTile_Newtron,obGfx(a0)		; use alternate palette line
