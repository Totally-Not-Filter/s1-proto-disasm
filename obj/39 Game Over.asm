...
Over_Main:
		...
		move.w	#$80-48,obX(a0)				; set start X-position for "GAME" object (offscreen left)
		tst.b	obFrame(a0)				; is this the "OVER" object?
...
.conjoined:
		move.w	#10*60,obTimeFrame(a0)			; set time delay to 10 seconds
