...
LWall_Index:	dc.w LWall_Main-LWall_Index		; 0
		dc.w LWall_ChkSonic-LWall_Index		; 2
		dc.w LWall_Solid-LWall_Index		; 4
...
LWall_Main:	; Routine 0
		addq.b	#2,obRoutine(a0)			; advance to LWall_ChkSonic
...
LWall_ChkSonic:	; Routine 4
	...
	.chkX:	cmpi.w	#224,d0					; is Sonic horizontally within 224 pixels of lava wall?
...
.checkMoveStart:
		...
		move.w	#$100,obVelX(a0)			; set lava wall to move to the right
		addq.b	#2,obRoutine(a0)			; advance to LWall_Solid
; ---------------------------------------------------------------------------
