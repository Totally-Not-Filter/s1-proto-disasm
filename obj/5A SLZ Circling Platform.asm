...
Circ_Main:	; Routine 0
		...
		move.w	#ArtTile_SLZ_Platform|Tile_Pal3,obGfx(a0) ; set art tile and palette
...
; ===========================================================================
Circ_TypeIndex:
		dc.w	Circ_Counterclockwise-Circ_TypeIndex	; subtype $x0
