...
; ---------------------------------------------------------------------------
	...
	if FixBugs
		andi.w	#1,d0					; limit to sane values
	else
	...
	if FixBugs
		andi.w	#$E,d0					; limit to sane values
	else
		...
		move.w	#ArtTile_SLZ_Platform|Tile_Pal3,obGfx(a0) ; set art tile and palette line
...
; ===========================================================================
Elev_TypeIndex:
		dc.w	Elev_Stationary-Elev_TypeIndex		; 0
